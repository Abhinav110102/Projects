...
class ForegroundOnlyLocationService : Service() {
    ...
    // Implement this method to provide the last known location
    fun getLastLocation(): Location? {
        // Implement logic here to retrieve the last known location
        // For example, you can use LocationManager to get the last known location
        return null // Return the last known location, or null if not available
    }
